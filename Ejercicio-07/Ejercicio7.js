...
class Ejercicio7 {
    ...
    recorrerArbolDom() {
        var stringDatos = "<article><h2>Recorrido de elementos HTML</h2><ul>";
        $("*", document.body).each(function() {
            var etiquetaPadre = $(this).parent().get(0).tagName;
            var etiquetaActual = $(this).get(0).tagName;
            var value = $(this).get(0).innerText;
            stringDatos += "<li>Etiqueta: &lt;" + etiquetaActual + "&gt; Etiqueta padre : &lt;" + etiquetaPadre + "&gt; Valor: " + value + "</li>";
